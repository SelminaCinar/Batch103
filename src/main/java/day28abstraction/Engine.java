...
/*
   ...
   "multiple inheritance" class'larda mumkun degildir fakat Java "interface" isimli yeni bir yapi olusturdu
    ...
    2)ınterface'lerdeki tum methodla "abstract" oldugu icin "interface"lere "fully abstraction" denir.
...
//interface'deki tum methodlar "abstract" olmak zorundadir.
    //interface'lerde abstract yazmaya gerek yoktur,cunku java o methodun abs oldugunu bilir.
...
// bu yuzden o methodlar icin "public" yazmaya gerek yoktur.
    ...
    //default keyword kullanarak interface'lerin icinde bodysi olan method'lar uretebilirsiniz.
    public default int add(int a ,int b){
        return a+b;
    }

    //static keyword kullanarak interface'lerin icinde bodysi olan method'lar uretebilirsiniz.
