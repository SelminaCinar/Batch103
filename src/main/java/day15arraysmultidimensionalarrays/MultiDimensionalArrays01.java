...
public class MultiDimensionalArrays01 {
    ...
    public static void main(String[] args) {
        ...
        //Multidimensional Array konsola nasıl yazdirilir?
        ...
        //Multidimensional Arraylerde iç Arraylerdeki elemanlar nasil yazdirilir?

        System.out.println(arr[1][0]);//6


        //Exaxmple 1: String bir Multidimensional Array olusturunuz
