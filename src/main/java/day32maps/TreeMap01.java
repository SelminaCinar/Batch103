...
public class TreeMap01 {
    ...
    /*
    1)TreeMap'ler entrySetleri key'lere gore "natural order" siralar.
    ...
    public static void main(String[] args) {
        ...
        //{Jimmy Jones=5000.0, Kevin Bridgeman=6000.0, Mary Star=1000.0, Tom Hanks=3000.0}

        //tailMap() verilen key'den sona kadar gider.
        SortedMap<String ,Double> map1 = salaries.tailMap("Kevin Bridgeman");
        System.out.println(map1);
        //{Kevin Bridgeman=6000.0, Mary Star=1000.0, Tom Hanks=3000.0}

        //tailMap(String,false) verilen key'den baslayarak verir ama verdiginiz keyi haric tutar.
