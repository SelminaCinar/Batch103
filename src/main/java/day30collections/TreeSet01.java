...
public class TreeSet01 {
    ...
    Note:Tekrarsiz elemanlari natural order da depolamak icin TreeSet kullanmak mantiklidir ama TreeSetler cok yavas calistigi icin
    ...
    public static void main(String[] args) {
        ...
        System.out.println(end1-start1);///13005500
        ...
        System.out.println(end2-end1);///1000400
