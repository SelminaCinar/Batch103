...
/*
  ...
  FIFO(First In First Out) ve LIFO(Last In First Out) gerektiginde beraber kullanilir.
 */
...
public class Deque01 {
    ...
    public static void main(String[] args) {
        ...
        throwing an IllegalStateException if no space is currently available. When using a capacity-restricted deque, it is generally preferable to use method offerFirst.
        ...
        //[Refrigerator, Chair, Mirror, Sofa, Bed, Bed, Bed, Dining Table]
